...
const FALLBACK: BlogPost[] = [
  { id: '1', title: 'The Power of Persistent Prayer', excerpt: 'Jesus taught us that men ought always to pray and not faint. Discover why persistence in prayer moves the heart of God and how to build a daily prayer habit that transforms your life.', content: '', category: 'Prayer', author: 'Rev. Emmanuel Cosby Oduro', status: 'published', views: 1840, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: '2', title: 'Faith That Moves Mountains', excerpt: 'A single mustard seed of faith is all it takes. Explore what real, mountain-moving faith looks like in everyday life and how you can activate it in your own situation.', content: '', category: 'Faith', author: 'Rev. Emmanuel Cosby Oduro', status: 'published', views: 2200, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: '3', title: "Healing Is the Children's Bread", excerpt: "God's will for your healing is clear throughout all of scripture. Learn how to receive your healing through an unshakeable confidence in God's Word and His covenant of health.", content: '', category: 'Healing', author: 'Rev. Emmanuel Cosby Oduro', status: 'published', views: 1560, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: '4', title: 'Intercession: Standing in the Gap', excerpt: 'What does it mean to intercede for another person? This devotional explores the biblical foundations of intercession and how you can become an effective intercessor.', content: '', category: 'Intercession', author: 'Rev. Emmanuel Cosby Oduro', status: 'published', views: 1020, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: '5', title: 'When God Seems Silent', excerpt: 'There are seasons when heaven feels distant and our prayers seem to bounce off the ceiling. This devotional helps you navigate the silence of God with faith and confidence.', content: '', category: 'Faith', author: 'Rev. Emmanuel Cosby Oduro', status: 'published', views: 3100, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
  { id: '6', title: 'The Grace to Begin Again', excerpt: "Grace is not just unmerited favour — it is the divine enabling to start fresh. No matter where you are today, God's grace is sufficient to give you a new beginning.", content: '', category: 'Grace', author: 'Rev. Emmanuel Cosby Oduro', status: 'published', views: 2480, created_at: new Date().toISOString(), updated_at: new Date().toISOString() },
]
