...
export function PrayerRequestSection() {
  ...
  return (
    <section className="py-24 bg-gradient-to-br from-amber-500 via-yellow-400 to-amber-600 relative overflow-hidden">
      {/* Decorative */}
      <div className="absolute inset-0 opacity-10" style={{ backgroundImage: "radial-gradient(circle at 20% 50%, white 1px, transparent 1px), radial-gradient(circle at 80% 20%, white 1px, transparent 1px)", backgroundSize: "60px 60px" }} />

      <div className="relative z-10 max-w-3xl mx-auto px-4 sm:px-6 text-center">
        <div className="text-5xl mb-5">🙏</div>
        <h2 className="font-serif text-4xl sm:text-5xl font-bold text-[#0A1628] mb-4">We're Praying For You</h2>
        <p className="text-[#0A1628]/65 text-lg mb-10 font-light leading-relaxed">Submit your prayer request and our dedicated prayer team will intercede for you. No request is too big or too small for God.</p>

        {!done ? (
          <div className="bg-white/92 backdrop-blur-sm rounded-3xl p-8 sm:p-10 text-left shadow-2xl">
            ...
            <div className="mb-4">
              ...
              <div className="flex flex-wrap items-center justify-between gap-4 mt-6">
                ...
                <button
                  ...
                  className="bg-gradient-to-r from-[#0A1628] to-[#1a2e50] text-amber-400 font-bold px-7 py-3 rounded-2xl hover:opacity-90 transition-opacity text-sm disabled:opacity-50"
                >
          ...
          <div className="bg-white/92 backdrop-blur-sm rounded-3xl p-12 shadow-2xl">
