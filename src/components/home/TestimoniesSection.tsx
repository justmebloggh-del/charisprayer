...
const FALLBACK: Testimony[] = [
  ...
  { id: '4', name: 'Samuel Boateng', location: 'Kumasi, Ghana', tag: 'Breakthrough', quote: 'My visa had been denied four times. After praying with the Charis Prayer community, my application was approved on the fifth attempt. Every impossible situation bows to prayer.', status: 'approved', created_at: '', updated_at: '' },
